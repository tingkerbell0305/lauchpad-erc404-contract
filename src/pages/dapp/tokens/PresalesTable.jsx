      ...
      <div className="flex mt-5 justify-start overflow-hidden w-full items-start flex-col border-gray border border-solid rounded-xl">
        ...
        <div className="w-full flex flex-col hideScroll justify-start items-start overflow-x-auto">
          <div className="grid min-w-[1100px] grid-cols-8 w-full gap-4 bg-gray bg-opacity-10 py-3 px-7 border-y border-y-gray border-solid">
            <p className="text-white font-semibold text-lg uppercase">Sale</p>
  ...
  return (
    <div className="grid min-w-[1100px] grid-cols-8 items-center w-full gap-4 py-3 pl-7 pr-8">
      ...
      <div className="flex justify-start items-start flex-col w-full gap-1">
        <div className="relative w-full rounded-full bg-gray overflow-hidden h-[6px]">
          <div className={`bg-cyan w-[60%] absolute left-0 top-0 h-full`}></div>
        </div>
        <div className="flex justify-between items-center w-full">
          <p className="text-sm text-white font-medium">1 ETH</p>
          <p className="text-sm text-white font-medium">50 ETH</p>
        </div>
      </div>
      <p className="text-white font-medium text-center">-</p>
